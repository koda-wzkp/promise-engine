...
export const WOD_PROMISES: Promise[] = [
  ...
  // ── Nixon's "War on Drugs" (1971) ──
  {
    ...
    domain: "Prevention",
    status: "violated",
    note: "Nixon Special Message to Congress, June 17, 1971. Created the Special Action Office for Drug Abuse Prevention (SAODAP) with $155M initial funding (~$1.1B adjusted). Past-month illicit drug use: ~5% (1972 National Household Survey) → 17.3% (2022 SAMHSA NSDUH). Drug overdose deaths: ~6,500 (1970) → 107,941 (2022, CDC WONDER). The stated goal of eradication was not achieved over 50+ years.",
