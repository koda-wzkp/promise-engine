...
const INSIGHTS = [
  { severity: "critical", type: "Cascade", title: "PacifiCorp's entire promise chain is broken",
...
function generateNarrative() {
  ...
  return {
    ...
    equity: `The law's promises to environmental justice communities, workers, and tribes are its weakest link \u2014 not because they've been broken, but because there's no way to tell. Three promises have no defined verification mechanism: the commitment to minimize burdens on EJ communities (\u00a72(4)), the workforce equity aspiration (\u00a72(2)), and the tribal consultation requirement (\u00a72(3)). Both utilities have convened their required Community Benefits Advisory Groups, but these are advisory bodies \u2014 they inform regulators, they don't determine compliance.`,
