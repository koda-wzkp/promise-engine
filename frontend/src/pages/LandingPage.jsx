...
const NavMark = () => (
  ...
  >
    ...
    <use href="#pp-mark" fill="#1a1a2e" className="pp-layer" style={{ animationDelay: '0s' }} />
    <use href="#pp-mark" fill="#1a5f4a" transform="scale(0.618)" className="pp-layer" style={{ animationDelay: '0.8s' }} />
    <use href="#pp-mark" fill="#1e40af" transform="scale(0.382)" className="pp-layer" style={{ animationDelay: '1.6s' }} />
    <use href="#pp-mark" fill="#5b21b6" transform="scale(0.236)" className="pp-layer" style={{ animationDelay: '2.4s' }} />
    <use href="#pp-mark" fill="#991b1b" transform="scale(0.146)" className="pp-layer" style={{ animationDelay: '3.2s' }} />
  </svg>
);
      ...
      <nav className="landing-nav" aria-label="Site navigation">
        <div className="landing-nav-inner">
          <a href="/" className="landing-nav-logo">
            <NavMark />
            <span className="landing-nav-name">Promise Pipeline</span>
            <span className="landing-nav-badge">Beta</span>
          </a>
          <div className="landing-nav-links">
            <a href="/hb2021" className="landing-nav-link">Live Demo</a>
